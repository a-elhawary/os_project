...
int do_noquantum(message *m_ptr)
{
	...
	case MLFQ:
		...
		rmp->time_slice = rmp->priority + 1 * 100;
		break;
	case RR:
...
// TODO
int calculateNextBurst(schedproc proc) {} // add required flags from msg
...
int do_start_scheduling(message *m_ptr)
{
	...
	rmp->expectedExecTime = rand() % 1000 + 2001; // expecred time from 2000 to 3000;
	// end students edits
